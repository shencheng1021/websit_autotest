...
time.sleep(5)
#driver.find_element(By.XPATH,"//div[@class='distpicker-address-wrapper']/label[1]/select").send_keys("北京市")
s=Select(driver.find_element(By.XPATH,"//div[@class='distpicker-address-wrapper']/label[1]/select"))
s.select_by_value("北京市")
#driver.find_element(By.XPATH,"//div[@class='distpicker-address-wrapper']/label[2]/select").send_keys("北京市")
c=Select(driver.find_element(By.XPATH,"//div[@class='distpicker-address-wrapper']/label[2]/select"))
c.select_by_value("北京市")
#driver.find_element(By.XPATH,"//div[@class='distpicker-address-wrapper']/label[3]/select").send_keys("朝阳区")
